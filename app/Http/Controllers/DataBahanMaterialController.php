...
class DataBahanMaterialController extends Controller
{
	...
	public function index()
	{
		...
		return view('databahanmaterial', compact('bahanmaterial', 'kategoritukang'));
	}
	...
	{
		$kategoritukang = \App\KategoriTukang::get();
		return view('tambahdatabahanmaterial', compact('kategoritukang'));
	}
	...
	public function edit($id)
	{
		...
		$kategoritukang = \App\KategoriTukang::get();
		return view('editdatabahanmaterial', compact('bahanmaterial', 'kategoritukang'));
	}
