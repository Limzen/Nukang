            ...
            <div class="navbar-inner">
                ...
                <ul class="navbar-nav d-lg-flex d-none">
                    ...
                    @elseif(Auth::user()->statuspengguna == "1")
                        <li><a href="{{ url('home') }}"
                                class="nav-link {{ Request::is('home') ? 'active' : '' }}">Dashboard</a></li>
                        <li><a href="{{ url('caritukang?kategori=all&jarak=10') }}"
                                class="nav-link {{ Request::is('caritukang*') ? 'active' : '' }}">Cari Jasa</a></li>
                        <li><a href="{{ url('riwayatpemesanan') }}"
                                class="nav-link {{ Request::is('riwayatpemesanan*') ? 'active' : '' }}">Pesanan</a></li>
                    @elseif(Auth::user()->statuspengguna == "2")
                        <li><a href="{{ url('home') }}"
                                class="nav-link {{ Request::is('home') ? 'active' : '' }}">Dashboard</a></li>
                        <li>
                            <a href="{{ url('permintaanpesanan') }}"
                                class="nav-link {{ Request::is('permintaanpesanan') ? 'active' : '' }}">
                                Permintaan
                        ...
                        <li><a href="{{ url('riwayatpemesanan') }}"
                                class="nav-link {{ Request::is('riwayatpemesanan*') ? 'active' : '' }}">Riwayat</a></li>
                    @elseif(Auth::user()->statuspengguna == "0")
                        <li><a href="{{ url('home') }}"
                                class="nav-link {{ Request::is('home') ? 'active' : '' }}">Verifikasi</a></li>
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{ url('databahanmaterial') }}" class="dropdown-item"><i class="fas fa-cube"></i>
                                    Bahan Material</a>
                                <a href="{{ url('datajenispemesanan') }}" class="dropdown-item"><i class="fas fa-list"></i>
                                    Jenis Pemesanan</a>
                                <a href="{{ url('datakategoritukang') }}" class="dropdown-item"><i class="fas fa-tags"></i>
                                    Kategori Tukang</a>
                            </div>
                        </li>
                        <li class="dropdown">
                            <a href="#"
                                class="nav-link {{ Request::is('riwayat*') || Request::is('konfirmasi*') ? 'active' : '' }}">
                                Riwayat <i class="fas fa-chevron-down" style="font-size: 0.6rem; margin-left: 4px;"></i>
                            </a>
                            <div class="dropdown-menu">
                                <a href="{{ url('riwayattransaksi') }}" class="dropdown-item"><i class="fas fa-receipt"></i>
                                    Transaksi</a>
                                <a href="{{ url('riwayatpemesanan') }}" class="dropdown-item"><i class="fas fa-history"></i>
                                    Pemesanan</a>
                                <div class="dropdown-divider"></div>
                                <a href="{{ url('konfirmasiupdatesaldo') }}" class="dropdown-item"><i
                                        class="fas fa-check-circle"></i> Konfirmasi Saldo</a>
                                <a href="{{ url('konfirmasitariksaldo') }}" class="dropdown-item"><i
                                        class="fas fa-money-bill-wave"></i> Konfirmasi Tarik</a>
                            </div>
                        </li>
                    @endif
                </ul>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    @if(Auth::guest())
                        <a href="{{ url('/auth/register') }}"
                            class="btn btn-secondary btn-sm d-md-inline-flex d-none">Daftar</a>
                    ...
                    @else
                        ...
                        <a href="{{ url('notifikasi') }}" class="btn btn-icon btn-ghost position-relative">
                            ...
                            @if(isset($totalnotifikasi) && $totalnotifikasi > 0)
                                <span class="badge badge-danger"
                                    style="position: absolute; top: 2px; right: 2px; font-size: 0.6rem; padding: 2px 5px;">{{ $totalnotifikasi }}</span>
                            @endif
                        </a>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-ghost d-flex align-items-center gap-2" style="padding: 6px 12px;">
                                <div
                                    style="width: 32px; height: 32px; background: var(--gradient-primary); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center;">
                            ...
                            <div class="dropdown-menu" style="right: 0; left: auto; min-width: 240px;">
                                ...
                                @elseif(Auth::user()->statuspengguna == "2")
                                    {{-- Quick action links already on dashboard --}}
                                @endif

                                <div class="dropdown-divider"></div>
                                <a href="{{ url('pengaturanakun') }}" class="dropdown-item"><i class="fas fa-user-cog"></i>
                                    Pengaturan Akun</a>
                                <a href="{{ url('/auth/logout') }}" class="dropdown-item" style="color: var(--danger);"><i
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-body">
            ...
            @elseif(Auth::user()->statuspengguna == "1")
                ...
                <a href="{{ url('caritukang?kategori=all&jarak=10') }}" class="mobile-nav-item"><i
                        class="fas fa-search"></i> Cari Jasa</a>
                ...
                <a href="{{ url('riwayatpemesanan') }}" class="mobile-nav-item"><i class="fas fa-history"></i> Riwayat
                    Pesanan</a>
                <a href="{{ url('tambahalamat') }}" class="mobile-nav-item"><i class="fas fa-map-marker-alt"></i> Alamat
                    Saya</a>
                ...
                <a href="{{ url('/auth/logout') }}" class="mobile-nav-item" style="color: var(--danger);"><i
                        class="fas fa-sign-out-alt"></i> Keluar</a>
            @elseif(Auth::user()->statuspengguna == "2")
                <a href="{{ url('home') }}" class="mobile-nav-item"><i class="fas fa-home"></i> Dashboard</a>
                ...
                <a href="{{ url('pengaturanjasakeahlian') }}" class="mobile-nav-item"><i class="fas fa-tools"></i> Jasa &
                    Keahlian</a>
                <a href="{{ url('penarikansaldo') }}" class="mobile-nav-item"><i class="fas fa-money-bill-wave"></i> Tarik
                    Saldo</a>
                <div class="mobile-nav-divider"></div>
                <a href="{{ url('pengaturanakun') }}" class="mobile-nav-item"><i class="fas fa-cog"></i> Pengaturan</a>
                <a href="{{ url('/auth/logout') }}" class="mobile-nav-item" style="color: var(--danger);"><i
            ...
            @else
                ...
                <a href="{{ url('databahanmaterial') }}" class="mobile-nav-item"><i class="fas fa-cube"></i> Bahan
                    Material</a>
                <a href="{{ url('datajenispemesanan') }}" class="mobile-nav-item"><i class="fas fa-list"></i> Jenis
                    Pemesanan</a>
                ...
                <div class="hero-stats">
                    ...
                    <div class="hero-stat animate-fadeIn stagger-3">
                        <div class="hero-stat-number">
                            {{ \App\Pemesanan::where('statuspemesanan', '>=', 3)->count() ?: '2500' }}+
                        </div>
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div>
                    ...
                    <ul class="footer-links">
                        <li><i class="fas fa-envelope" style="margin-right: 8px; color: var(--success);"></i>
                            hello@markettukang.com</li>
                        <li><i class="fas fa-phone" style="margin-right: 8px; color: var(--success);"></i> +62 21 1234
                            5678</li>
                        <li><i class="fas fa-map-marker-alt" style="margin-right: 12px; color: var(--success);"></i>
                            Medan, Indonesia</li>
                    </ul>
                </div>
            </div>
