        ...
        <div class="container">
            ...
            <div class="stats-row animate-fadeIn">
                @php
                    ...
                    $topup = $riwayattransaksi->where('jenistransaksi', 'Pengisian Saldo')->count();
                    $pembayaran = $riwayattransaksi->whereIn('jenistransaksi', ['Pembayaran Biaya Jasa', 'Pembayaran Jasa'])->count();
                    $withdraw = $riwayattransaksi->where('jenistransaksi', 'Penarikan Saldo')->count();
                @endphp
                <div class="stat-card">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <span class="stat-label">Pengisian Saldo</span>
                    </div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon stat-icon-blue"><i class="fas fa-credit-card"></i></div>
                    <div class="stat-info">
                        <span class="stat-number">{{ $pembayaran }}</span>
                        <span class="stat-label">Pembayaran Jasa</span>
                    </div>
                </div>
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <span class="stat-label">Penarikan Saldo</span>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            if ($value->jenistransaksi == 'Pengisian Saldo') {
                                                $badgeClass = 'badge-success';
                                            } elseif ($value->jenistransaksi == 'Pembayaran Biaya Jasa' || $value->jenistransaksi == 'Pembayaran Jasa') {
                                                $badgeClass = 'badge-blue';
                                            } elseif ($value->jenistransaksi == 'Penarikan Saldo') {
                                    ...
                                    <td>
                                        @if($value->buktitransaksi)
                                            <a href="{{ asset('images/buktitransfer') }}/{{ $value->buktitransaksi }}"
