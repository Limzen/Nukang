...
<div class="dashboard-container">
    ...
    <div class="stats-grid">
        <div class="stat-card stat-warning">
            ...
            <div class="stat-badge badge-warning">Pending</div>
        </div>
    ...
    <div class="quick-actions-section">
        ...
        <div class="quick-actions-grid">
            ...
            <a href="{{ url('/pengaturan-akun') }}" class="action-card">
                <div class="action-icon action-icon-cyan">
                    <i class="fas fa-user-cog"></i>
                </div>
                <div class="action-content">
                    <span class="action-title">Edit Profil</span>
                    <span class="action-desc">Update informasi</span>
                </div>
            </a>
            ...
            <a href="{{ url('/notifikasi') }}" class="action-card">
                <div class="action-icon action-icon-pink">
                    <i class="fas fa-bell"></i>
                </div>
                <div class="action-content">
                    <span class="action-title">Notifikasi</span>
                    <span class="action-desc">Lihat update terbaru</span>
                </div>
            </a>
        </div>
    </div>
            ...
            <div class="profile-stats-grid">
                ...
                <div class="profile-stat-item">
                    ...
                    <div>
                        ...
                        <span class="stat-value-sm {{ $tukangData->statusjasakeahlian == '1' ? 'status-active' : 'status-inactive' }}">
...
.stat-gold .stat-icon { background: linear-gradient(135deg, #f59e0b, #d97706); }
