                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="isiulasan" rows="4" placeholder="Bagikan pengalaman Anda..." required></textarea>
                        </div>
                            ...
                            <div class="review-item">
                                ...
                                <div class="review-content">
                                    <div class="review-header">
                                        ...
                                        <span class="review-date">{{ \Carbon\Carbon::parse($value->tanggalulasan)->format('d M Y') }}</span>
                                    </div>
...
.reviews-summary { background: var(--bg-card); border: 1px solid var(--border-primary); border-radius: var(--radius-xl); padding: var(--space-8); text-align: center; margin-bottom: var(--space-6); }
.summary-rating .big-rating { font-family: var(--font-display); font-size: 4rem; font-weight: 700; color: var(--text-primary); display: block; }
.summary-rating .stars { color: #fbbf24; font-size: 1.5rem; margin: var(--space-2) 0; }
.summary-rating .review-count { color: var(--text-tertiary); }
...
.content-card .card-icon-purple { background: linear-gradient(135deg, #8b5cf6, #a855f7); }
...
.form-control { width: 100%; padding: var(--space-3) var(--space-4); background: var(--bg-tertiary); border: 1px solid var(--border-primary); border-radius: var(--radius-lg); color: var(--text-primary); }
.form-control:focus { outline: none; border-color: var(--success); }
.star-rating-input { display: flex; flex-direction: row-reverse; justify-content: flex-end; gap: var(--space-1); }
.star-rating-input input { display: none; }
.star-rating-input label { cursor: pointer; font-size: 1.5rem; color: var(--border-primary); transition: color 0.2s; }
.star-rating-input input:checked ~ label,
.star-rating-input label:hover,
.star-rating-input label:hover ~ label { color: #fbbf24; }
.reviews-list { display: flex; flex-direction: column; gap: var(--space-4); }
.review-item { display: flex; gap: var(--space-4); padding: var(--space-5); background: var(--bg-tertiary); border-radius: var(--radius-lg); }
.review-avatar img { width: 50px; height: 50px; border-radius: var(--radius-lg); object-fit: cover; }
.review-content { flex: 1; }
.review-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: var(--space-2); }
.review-header h4 { font-size: 0.95rem; }
.review-date { font-size: 0.8rem; color: var(--text-tertiary); }
.review-rating { margin-bottom: var(--space-2); }
.review-rating i { font-size: 0.85rem; color: var(--border-primary); }
.review-rating i.active { color: #fbbf24; }
.review-text { color: var(--text-secondary); line-height: 1.6; margin: 0; }
