                    ...
                    <div class="card-body">
                        <div class="form-field">
                            ...
                            @if(Auth::user()->statuspengguna == '2')
                                <input type="text" name="name" value="{{ Auth::user()->namatukang }}" required>
                            @else
                                <input type="text" name="name" value="{{ Auth::user()->namapelanggan }}" required>
                            @endif
                        </div>
                        <div class="form-field">
                            <label><i class="fas fa-phone"></i> Nomor Handphone</label>
                            <input type="tel" name="nomorhandphone" value="{{ Auth::user()->nomorhandphone }}" placeholder="+62 xxx xxxx xxxx">
                        </div>
                        <div class="form-field">
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-field">
                                ...
                                <input type="text" name="nomorrekening" value="{{ Auth::user()->nomorrekening }}" placeholder="xxxx-xxxx-xxxx">
                            </div>
                            <div class="form-field">
                                <label><i class="fas fa-user-tag"></i> Nama Rekening</label>
                                <input type="text" name="namarekening" value="{{ Auth::user()->namarekening }}" placeholder="Nama sesuai rekening">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="photo-upload">
                            <div class="photo-preview" id="photoPreview">
                                @if(Auth::user()->fotoprofil)
                                    <img src="{{ asset('images/fotoprofil') }}/{{ Auth::user()->fotoprofil }}" alt="Profile" id="previewImg">
                                @else
                    ...
                    <div class="location-coords">
                        <span id="coordsDisplay">
                            @if(Auth::user()->latitude && Auth::user()->longtitude)
                                <i class="fas fa-check-circle"></i> Lokasi tersimpan: {{ Auth::user()->latitude }}, {{ Auth::user()->longtitude }}
                            @else
