                        ...
                        <div class="request-card animate-fadeIn" style="animation-delay: {{ $key * 0.1 }}s">
                            ...
                            <div class="request-body">
                                ...
                                <div class="proof-section">
                                    ...
                                    <a href="{{ asset('images/buktitransfer') }}/{{ $value->buktitransaksi }}" target="_blank"
                                        class="proof-image">
                            ...
                            <div class="request-actions">
                                <form action="{{ url('konfirmasi-update-saldo/terima') }}" method="POST" class="action-form">
                                    @csrf
                                ...
                                <form action="{{ url('konfirmasi-update-saldo/tolak') }}" method="POST" class="action-form">
                                    @csrf
                                    <input type="hidden" name="idriwayat" value="{{ $value->id_riwayattransaksi }}">
