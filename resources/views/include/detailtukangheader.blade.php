...
<div class="tab-navigation animate-fadeIn">
    <a href="{{ url('cari-tukang') }}/{{ $idtukang }}/rincian-biaya"
        class="tab-item {{ Request::is('cari-tukang/*/rincian-biaya') ? 'active' : '' }}">
        <i class="fas fa-money-bill-wave"></i> Rincian Biaya
    </a>
    <a href="{{ url('cari-tukang') }}/{{ $idtukang }}/pengalaman-bekerja"
        class="tab-item {{ Request::is('cari-tukang/*/pengalaman-bekerja') ? 'active' : '' }}">
        <i class="fas fa-briefcase"></i> Pengalaman
    </a>
    <a href="{{ url('cari-tukang') }}/{{ $idtukang }}/deskripsi-keahlian"
        class="tab-item {{ Request::is('cari-tukang/*/deskripsi-keahlian') ? 'active' : '' }}">
        <i class="fas fa-tools"></i> Keahlian
    </a>
    <a href="{{ url('cari-tukang') }}/{{ $idtukang }}/komentar-pelanggan"
        class="tab-item {{ Request::is('cari-tukang/*/komentar-pelanggan') ? 'active' : '' }}">
        <i class="fas fa-comments"></i> Ulasan
    </a>
    <a href="{{ url('cari-tukang') }}/{{ $idtukang }}/lokasi"
        class="tab-item {{ Request::is('cari-tukang/*/lokasi') ? 'active' : '' }}">
