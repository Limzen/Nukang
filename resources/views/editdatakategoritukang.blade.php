    ...
    <div class="form-card">
        ...
        <div class="form-header">
            ...
            <div class="header-text">
                <h2>Edit Kategori Tukang</h2>
                <p>Perbarui informasi kategori tukang</p>
            </div>
        </div>
        ...
        <div class="form-body">
            {{-- Form --}}
            <form class="premium-form" role="form" method="POST" action="{{ url('datakategoritukang/' . $kategoritukangte->id_kategoritukang) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <textarea 
                            ...
                            required
                        >{{ $kategoritukangte->kategoritukang }}</textarea>
